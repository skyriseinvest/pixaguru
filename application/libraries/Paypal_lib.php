...
class Paypal_lib
{
	...
	function __construct(){
		...
		$businessEmail =$access['sandbox_accounts'];
	...
	function PayPalAcceess(){       
        ...
        $data['paypal_client_id'] = !empty($paymentSetting) ? $paymentSetting['paypal_client_id'] : '';
        $data['sandbox_accounts'] = !empty($paymentSetting) ? $paymentSetting['sandbox_accounts'] : '';      
        return $data;
    } 
